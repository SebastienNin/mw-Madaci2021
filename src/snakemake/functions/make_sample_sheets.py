...
if os.path.isfile("../mw-sst/Sequencing_summary.xlsx"):
    ...
    samples_from_bcl = samples[samples['origin'].isin(['bcl', 'bcl_no_mismatch', 'bcl_with_fastq_index'])]
    ...
    for experiment in experiments_from_bcl:
        ...
        if(['scRNA', 'scRNA_HTO'] in current_df.type.unique()):
        ...
        if(['scRNA', 'scRNA_HTO'] not in current_df.type.unique()):
